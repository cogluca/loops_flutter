                    ...
                    Container(
                      child: Obx(() => Center(
                            ...
                            onChanged: (bool value) {
                              String currentSprintId = Get.find<GetStorage>()
                                  .read('currentProjectSprintId');
                              if (currentSprintId.isEmpty) {
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext contextOfDialog) {
                                      return AlertDialog(
                                        title:
                                            const Text('Ops! No active sprint'),
                                        content: Column(
                      ...
                      children: [
                        TextButton(
                            ...
                            style: TextButton.styleFrom(
                                backgroundColor: const Color(0xFFf5d271))),
                        TextButton(
                            onPressed: () => {Navigator.pop(context)},
                            child: const Text('Cancel', style: TextStyle(
                              color: Color(0xFFed1148),
                            ),
                            ),
                            style: TextButton.styleFrom(
                             padding: const EdgeInsets.only(
                               ...
                               right: 20
                                ...
                                backgroundColor: const Color(0xFFf27997)))
                      ],
